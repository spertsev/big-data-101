...
public class SqlHandlerBaseTest {
    ...
    @Test
    public void makeDatasetWithQueryingCsvShouldReturnCorrectDataset() {
        File testCsv;
        Dataset<Row> datasetMadeByReadingCsv;
        String testSqlQuery = "SELECT date_time FROM train";
        try {
            ...
            datasetMadeByReadingCsv = SqlHandlerBase.makeDatasetWithQueryingCsv(testCsv.getAbsolutePath(), testSqlQuery);
